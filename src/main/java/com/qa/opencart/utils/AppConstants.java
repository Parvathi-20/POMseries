...
public class AppConstants {
	...
	public static final int SHORT_DEAFULT_WAIT = 5;
	public static final int MEDIUM_DEFAULT_WAIT = 5;

	public static final int LONG_DEAFULT_WAIT = 5;

	public static final List<String> EXP_ACC_HEADERS_LIST = Arrays.asList("My Account", "My Orders",
			"My Affiliate Account", "Newsletter");

	
	public static final String LOGIN_ERROR_MESSAGE = "Warning: No match";
